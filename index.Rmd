...
This is how tsibble provides formal organisation on how to tidy your temporal data.
...
The length of output is not stable, depending on the the choice of window size. This is for loop
...
We a rolling family with 3 variants
